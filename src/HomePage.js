...
return (
  <div className="app" style={{
    ...
    <div className="container" style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
      ...
      <p style={{ color: "#cbd5e1", fontSize: "18px", lineHeight: "1.8", marginBottom: "24px" }}>
      ...
      <ul style={{ color: "#e2e8f0", fontSize: "17px", paddingLeft: "20px", lineHeight: "1.9", marginBottom: "30px", textAlign: "left" }}>
